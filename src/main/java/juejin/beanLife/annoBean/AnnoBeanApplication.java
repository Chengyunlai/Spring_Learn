package juejin.beanLife.annoBean;



import juejin.beanLife.annoBean.bean.Person;
import juejin.beanLife.annoBean.config.BeanLifeConfig;
 ...
 * @Version 1.0
 **/
public class AnnoBeanApplication {
